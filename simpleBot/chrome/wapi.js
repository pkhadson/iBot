    ...
    function getStore(modules) {
      ...
      let neededObjects = [
        ...
        },
        {
          id: "MediaObject",
          conditions: (module) =>
            module.getOrCreateMediaObject &&
            module.disassociateMediaFromStickerPack
              ? module
              : null,
        },
        {
        ...
        },
        {
          id: "Vcard",
          conditions: (module) =>
            module.vcardFromContactModel ? module : null,
        },
        {
          id: "Profile",
          conditions: (module) =>
            module.sendSetPicture && module.requestDeletePicture
              ? module
              : null,
        },
        {
        ...
        },
        {
          id: "GroupMetadata",
          conditions: (module) =>
            module.default && module.default.handlePendingInvite
              ? module
              : null,
        },
        {
        ...
        },
        {
          id: "ws2",
          conditions: (module) =>
            module.default && module.default.destroyStorage
              ? module.default
              : null,
        },
        {
        ...
        },
        {
          id: "BlobCache",
          conditions: (module) =>
            module.default && module.default.getOrCreateURL
              ? module.default
              : null,
        },
        {
        ...
        },
        {
          ...
          conditions: (module) =>
            module.sendPromoteParticipants
              ? module.sendPromoteParticipants
              : null,
        },
        {
...

        {
          id: "checkNumberBeta",
          conditions: (module) =>
            module.queryPhoneExists && module.queryExists
              ? module.queryExists
              : null,
        },
        {
...
window.WAPI.isMultiDeviceVersion = function () {
  return Store.FeatureChecker.default.supportsFeature(
    Store.FeatureChecker.default.F.MD_BACKEND
  );
};
...
window.WAPI.onAnyMessage = (callback) =>
  window.Store.Msg.on("add", (newMessage) => {
    if (newMessage && newMessage.isNewMsg) {
      ...
      if (
        newMessage.clientUrl == null ||
        newMessage.clientUrl == undefined ||
        newMessage.clientUrl == ""
      ) {
        newMessage.clientUrl = newMessage.deprecatedMms3Url;
      }
...
window.WAPI.sendFile = async function (
  imgBase64,
  chatid,
  filename,
  caption,
  ...
  if (chat.erro === false || chat.__x_id) {
    if (chat.__x_id._serialized !== chatid) {
      return "ERROR: not a valid Whatsapp";
    }
    ...
    var mediaBlob = WAPI.base64ToFile(imgBase64, filename),
      ...
      result = await Promise.all(
        ListChat
          ? await media.sendToChat(chat, { caption: caption, ...extras })
          : ""
      );
    result = result.join("");
...
window.WAPI.sendExist = async function (
  chatId,
  returnChat = true,
  Send = true
) {
...
window.WAPI.reply = async function (chatId, body, quotedMsg) {
  let chat = await WAPI.getExistentChat(chatId);
  if (!chat) {
    return WAPI.sendMessageToID(chatId, body);
  }

  if (typeof quotedMsg !== "object")
    quotedMsg = await window.WAPI.getMessageById(quotedMsg, null, false);
